...
const MobileOrientGraph = ({ data, setData }) => {
  ...
  if (isPortrait) {
    return (
      <div style={{ 
        ...
        <h3 style={{ margin: '0 0 8px 0' }}>Please Rotate Your Device</h3>
        <p style={{ margin: '0', color: '#94a3b8', fontSize: '14px' }}>The lifelong timeline is best experienced in landscape orientation.</p>
        <p style={{ margin: '16px 0 0', color: '#64748b', fontSize: '12px' }}>Resize window horizontally to simulate landscape.</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <p style={{ textAlign: 'center', color: '#94a3b8', fontSize: '13px', marginBottom: '8px' }}>
        Try making the window narrower to trigger the portrait orientation warning.
      </p>
      <svg 
        ref={svgRef}
        className="svg-graph"
...
export default MobileOrientGraph;
